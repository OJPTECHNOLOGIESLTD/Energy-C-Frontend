  ...
  return (
    <div className="w-full">
      <div className="flex items-center w-full py-6 relative">
        ...
        <Text variant="h2" size="base" className="flex-1 text-center">
          {info.name} Details
        </Text>
      </div>
      <ImageViewer
      ...
      <div className="p-4">
        <div className="flex justify-between mt-4">
          <Text variant="h2" customSize="15px">
            {info.name}
          </Text>{" "}
          <Text variant="h2" customSize="15px">
            NGN {info.price}/kg
        ...
        <Text customSize="11px" variant="h3" className="mt-3">
        ...
        <Text customSize="11px">
          Start recycling plastic waste today and make a difference!
        </Text>

        <div className="mt-4 mb-6">
          <div className="flex flex-col gap-2 mb-6">
            <Text customSize="11px" variant="h3">
              ...
              <div className="mt-4 flex items-center justify-between">
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex gap-3 items-center">
                    <Button
                      title={
                        <BiMinus size={15} style={{ fontWeight: "bold" }} />
                      }
                      variant="secondary"
                    ...
                    <Button
                      title={
                        <BiPlus size={15} style={{ fontWeight: "bold" }} />
                      }
                      variant="secondary"
                      className="w-[40px] h-[40px] rounded-full"
                      isIconOnly
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <div className="rounded-full border min-w-[133px] border-[#ABB7C2] p-2 justify-center text-center">
                    <Text variant="h2" customSize="15px">
                      {price}
                    </Text>
                  </div>
